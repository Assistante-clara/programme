...
console.log("le chemin des logiciels est : "+chemin+" changer dans le :   programme.js    :si cela beug".red)
...
if(data.listprog==1){
  console.log("mise à jour des logiciels")
   ...
   var recursiveReadSync = require('recursiveprogramme'), files  ;
    console.log("le chemin des logiciels est : "+chemin+" changer dans le :   programme.js    :si cela beug")
...
ClaraIASpeech("fichier mis à jour|pas trop long ?|j'espere que j'ai tout trouvé")
 return false  
   }//fin try
